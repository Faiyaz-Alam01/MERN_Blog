...
BlogRoute.get('/get-all',authenticate, showAllBlog); // when user isLoggedIn then show data in index.jsx
...
BlogRoute.get('/blogs', getAllBlogs); // public route blogs shows on index js
